...
<head>
  ...
  <title>{$i18n->get('reset-password')} &mdash; {$config["appName"]}</title>
          ...
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h4>{$i18n->get('reset-password')}</h4>
              </div>

              <div class="card-body">
                <p class="text-muted">{$i18n->get('reset-password-info')}</p>
                ...
                <div class="form-group">
                  <button id="reset" type="submit" class="btn btn-primary btn-lg btn-block" tabindex="4">
                    {$i18n->get('reset-password-page-button')}
                  </button>
                </div>
              </div>
            </div>
            <div class="mt-5 text-muted text-center">
              <a href="/auth/login">{$i18n->get('back-to-login')}</a>
            </div>
